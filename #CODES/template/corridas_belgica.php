		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					...
					<section>
						<header class="major">
							<img src="images/belgicaflag.jpg" width="65" height="50" align="left">
							<img src="images/firelli.png" width="150" height="75" align="right">
							<font size="5">&nbsp;&nbsp;<b>2017 FORMULA 1 PIRELLI BELGIAN GRANDE PRÉMIO</b>
							<p>&nbsp;&nbsp;Spa-Francorchamps</p></font>
					...
					<td><img src="images/belgia.png" width="900" height="700"></td>
					</th>
					<th style="display: inline-block;">
					<td class="td2" >
						<a href="start_belgica.php">Grelha de partida</a> 
						<br><br><br> 
						<a href="results_belgica.php">Resultado</a>
						<br><br><br>
						<a href="">Campeonato</a>
					</td>
