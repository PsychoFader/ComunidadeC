		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					...
					<section>
						<header class="major">
							<img src="images/japaoflag.jpg" width="65" height="50" align="left">
							<font size="5">&nbsp;&nbsp;<b>2017 FORMULA 1 GRANDE PRÉMIO DE JAPÃO</b>
							<p>&nbsp;&nbsp;Suzuka</p></font>

							<span class="byline"></span>
						</header>
						<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PERCURSO INTERNACIONAL SUZUKA</h3>
					...
					<td><img src="images/japao.png" width="900" height="700"></td>
					</th>
					<th style="display: inline-block;">
					<td class="td2" >
						<a href="start_japao.php">Grelha de partida</a> 
						<br><br><br> 
						<a href="results_japao.php">Resultado</a>
						<br><br><br>
						<a href="">Campeonato</a>
					</td>
