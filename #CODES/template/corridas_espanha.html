		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					...
					<section>
						<header class="major">
							<img src="images/espanhaflag.gif" width="65" height="50" align="left">
							<img src="images/firelli.png" width="150" height="75" align="right">
							<font size="5">&nbsp;&nbsp;<b>2017 FORMULA 1 GRANDE PRÉMIO DE ESPANHA PIRELLI</b>
							<p>&nbsp;&nbsp;Catalunha</p></font>

							<span class="byline"></span>
						</header>
						<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CIRCUITO DE BARCELONA-CATALUNHA</h3>
					...
					<td><img src="images/espanha.png" width="900" height="700"></td>
					</th>
					<th style="display: inline-block;">
					<td class="td2" >
