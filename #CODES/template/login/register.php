...
<body>
    <div class="login-card">
        <form action="register.php" class="form-signin"><span class="reauth-email"><h3>Registação </h3></span>
			...
			<input class="form-control" type="text" required="" placeholder="Nome" id="inputEmail" name="username">
