		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					...
					<section>
						<header class="major">
							<img src="images/australiaflag.jpg" width="65" height="50" align="left">
							<img src="images/rolex.png" width="150" height="75" align="right">
							<font size="5">&nbsp;&nbsp;<b>2017 FORMULA 1 ROLEX GRANDE PRÉMIO DA AUSTRÁLIA</b>
							<p>&nbsp;&nbsp;Melbourne</p></font>

							<span class="byline"></span>
						</header>
						<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MELBOURNE GRANDE PRÉMIO CIRCUITO</h3>
					...
					<td><img src="images/pistaaustralia.png" width="900" height="700"></td>
					</th>
					<th style="display: inline-block;">
					<td class="td2" >
