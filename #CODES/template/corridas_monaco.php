		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					...
					<section>
						<header class="major">
							<img src="images/monacoflag.jpg" width="65" height="50" align="left">
							
							<font size="5">&nbsp;&nbsp;<b>FORMULA 1 GRANDE PRÉMIO DE MONACO 2017</b>
							<p>&nbsp;&nbsp;Monte Carlo</p></font>
					...
					<td><img src="images/monaco.png" width="900" height="700"></td>
					</th>
					<th style="display: inline-block;">
					<td class="td2" >
						<a href="start_monaco.php">Grelha de partida</a> 
						<br><br><br> 
						<a href="results_monaco.php">Resultado</a>
						<br><br><br>
						<a href="">Campeonato</a>
					</td>
