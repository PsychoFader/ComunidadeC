		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					...
					<section>
						<header class="major">
							<img src="images/austriaflag.gif" width="65" height="50" align="left">
							<font size="5">&nbsp;&nbsp;<b>2017 FORMULA 1 GRANDE PRÉMIO DA ÁUSTRIA</b>
							<p>&nbsp;&nbsp;Spielberg</p></font>

							<span class="byline"></span>
						</header>
						<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RED BULL CIRCUITO</h3>
					...
					<td><img src="images/austria.png" width="900" height="700"></td>
					</th>
					<th style="display: inline-block;">
					<td class="td2" >
						<a href="start_osterreich.php">Grelha de partida</a> 
						<br><br><br> 
						<a href="results_osterreich.php">Resultado</a>
						<br><br><br>
						<a href="">Campeonato</a>
					</td>
