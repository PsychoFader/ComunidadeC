		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					...
					<section>
						<header class="major">
							<img src="images/malaysiaflag.jpg" width="65" height="50" align="left">
							<img src="images/petronas.png" width="150" height="75" align="right">
							<font size="5">&nbsp;&nbsp;<b>2017 FORMULA 1 PETRONAS GRANDE PRÉMIO DA MALÁSIA</b>
							<p>&nbsp;&nbsp;Kuala Lumpur</p></font>

							<span class="byline"></span>
						</header>
						<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CIRCUITO INTERNACIONAL SEPANG</h3>

						<table style="width:50%">
					  <tr>
					    <th>Primeiro Grande Prémio</th>
					    <th>Número de voltas</th> 
					    <th>Comprimento do circuito</th>
					    <th>Distância da corrida</th>
					...
					<td><img src="images/malaysia.png" width="900" height="700"></td>
					</th>
					<th style="display: inline-block;">
					<td class="td2" >
						<a href="start_malasia.php">Grelha de partida</a> 
						<br><br><br> 
						<a href="results_malasia.php">Resultado</a>
						<br><br><br>
						<a href="">Campeonato</a>
					</td>
